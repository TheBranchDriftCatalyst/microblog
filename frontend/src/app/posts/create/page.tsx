          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col">
              ...
              <Input
                ...
                className="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              />
            </div>
            {/* Content Input */}
            <div className="flex flex-col">
              ...
              <Textarea
                className="mt-1 block w-full h-48 px-3 py-2 border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm resize-none"
                id="Content"
